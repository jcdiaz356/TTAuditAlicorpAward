...
public final class GlobalConstant {
    ...
    public static final String ALBUN_NAME = "award_Photo";
    public static final String ALBUN_NAME_TEMP = "award_Photo_Temp";
    public static final String ALBUN_NAME_BACKUP = "award_Photo_Backup";
