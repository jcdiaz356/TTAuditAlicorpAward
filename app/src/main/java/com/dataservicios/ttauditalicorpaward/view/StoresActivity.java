...
import com.dataservicios.ttauditalicorpaward.adapter.StoreAdapterReciclerView;
...
public class StoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store_id_parent = bundle.getInt("store_id_parent");
       ...
       // new loadStores().execute();
        ...
        //stores = (ArrayList<Store>) storeRepo.findByRouteId(route_id);
        //stores = (ArrayList<Store>) storeRepo.findByRouteIdAndLevel(route_id,1);
        stores = (ArrayList<Store>) storeRepo.findByRouteIdAndStoreIdParent(route_id,store_id_parent);
