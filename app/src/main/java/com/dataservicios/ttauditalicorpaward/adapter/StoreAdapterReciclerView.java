package com.dataservicios.ttauditalicorpaward.adapter;
...
import com.dataservicios.ttauditalicorpaward.view.StoreAuditActivity;
import com.dataservicios.ttauditalicorpaward.view.StoresActivity;
...
//                activity.startActivity(intent);
                ...
                if(store.getLevel()==1) {
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putInt("route_id", Integer.valueOf(store.getRoute_id()));
                    bundle.putInt("store_id_parent", Integer.valueOf(store.getId()));
